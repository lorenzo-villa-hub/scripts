               ...
               for line in origin_file:
                 # emulating 'grep' command
                  ...
                  if job_line:
                      ...
                      new_job_vasp_file.write(f'#SBATCH --job-name=N_P_{step_number} \n')
                  else:
                           ...
                           for line in origin_file:
                             # emulating 'grep' command
                              ...
                              if job_line:
                                  ...
                                  new_job_vasp_file.write(f'#SBATCH --job-name=N_{el}{q}_{step_number} \n')
                              else:
                                  # if line doesn't contain job-name write same line from reference job_vasp.sh
                                  new_job_vasp_file.write(line)                             
                           new_job_vasp_file.close()
