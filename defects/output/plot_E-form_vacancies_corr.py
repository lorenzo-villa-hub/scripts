...
if get_single_plots:
    for res in reservoirs:
        ...
        for item in defect_types:       
            ...
            data = np.loadtxt(f'./{item}-vacancy/{res}/{item}-vacancy-plot_corr.dat', dtype = 'f')
        ...
        plt.legend()    
     #   plt.show()
        plt.savefig(f'./{item}-vacancy/{res}/NN_{fun_xc}_vacancies_res{res}_E-form_corr.pdf')
###############################################################################
...
#plt.show()
plt.savefig(f'./NN_{fun_xc}_vacancies_E-form_corr.pdf')
