...
#input_path = '/nfshome/villa/local-data/NN_cubic/vacancies-PBE/O-vacancy'
...
###############################################################################
    ...
    #input_frey = '/nfshome/villa/local-data/NN_cubic/freysold-corr-vacancies-PBE/O-vacancy/'
    ...
    for charge in final_dict:
        ...
        print(charge , final_dict[charge])
    print('')
